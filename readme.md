...
Программа для экспорта данных Яндекс.Метрики в MS Excel, с использованием надстройки [Power Query](https://www.microsoft.com/en-us/download/details.aspx?id=39379&WT.mc_id=Blog_PBI_Announce_DI).
